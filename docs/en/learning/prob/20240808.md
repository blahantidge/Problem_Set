...
West has led the ♣️Q, and East wins the first trick with the ♣️A. Your ♣️K is now promoted to a winner. East shifts to the ♦️10 and you have your first decision. Should you try the diamond finesse right now?
...
Since the repeated finesse in spades has a 75% chance of success, it might seem you should start there. If it works, you might even be able to discard your diamond loser and not need to try the finesse in that suit. So let's see what will happen if you try a spade finesse at this point. Suppose you lead the ♠️J, tempting West to cover with an honor. Then you will be able to win the ♠️A, drive out the remaining spade honor, and finish with an overtrick by discarding your diamond on dummy's extra spade winner.
...
[<Badge type="info" text="-->"/>](/en/learning/prob/20240808#links)
